...
## Project Structure
    ...
    ├── testapiautosetting_127321  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127321`
...
2. Clone this repo and `cd testapiautosetting_127321`
